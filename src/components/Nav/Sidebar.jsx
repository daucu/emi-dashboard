...
const Sidebar = ({ status }) => {
  return (
    <div
      ...
      } relative top-0 flex flex-col flex-wrap border-r border-gray-300 px-3 py-2 lg:w-[18%] h-[100%] animated faster overflow-y-scroll overflow-x-hidden
    max-lg:fixed max-lg:top-[68px] max-lg:pb-[68px] w-[250px] left-0 z-20 bg-white
    `}
    >
